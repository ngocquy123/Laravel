    <div>
        <div class="row">
            <div class="col-md-3">
              ...
              @endif
              <div class="card">
                <div class="card-header"><h4>Giá</h4></div>
                <div class="card-body">
                    <label class="d-block">
                        <input type="radio" name="priceSort" wire:model="priceInput" value="cao-thap"> Cao - Thấp
                    </label>
                    <label class="d-block">
                        <input type="radio" name="priceSort" wire:model="priceInput" value="thap-cao"> Thấp - Cao
                    </label>
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                <div class="row">
                    ...
                    @empty
                        <div class="col-md-12">
                            <div class="p-2">
                                <h4> Sản phẩm {{$category->name}}  không có sẵn</h4>
                            </div>
                        </div>
                    @endforelse
                </div>
